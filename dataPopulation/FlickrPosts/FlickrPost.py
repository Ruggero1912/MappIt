...
class FlickrPost(Post):
    ...
    def __init__(self, author_id, flickr_post_id : str, title=None, description=None, post_date: datetime = None, exp_date=None, tags_array: list = [], activity=None, pics_array: list = [], thumbnail=None) -> None:
